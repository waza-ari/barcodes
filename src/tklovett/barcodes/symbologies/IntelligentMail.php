...
/**
 * Intelligent Mail (Onecode, USPS-B-3200)
 * A 65-bar code for use on mail in the United States.
 ...
 */
class IntelligentMail extends OneDimensionalBarcode
{
    /**
     * Construct an Intelligent Mail barcode array
