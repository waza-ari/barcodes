 ...
 */
class Code39 extends OneDimensionalBarcode
{
    /**
     * Construct a Code 39 barcode array
     * @param string $code The code to be represented by this barcode.
     * @param bool $checkDigit add a check digit to the code
     * @param bool $extended use the extended mode
     */
    function __construct($code, $checkDigit = false, $extended = false)
    {
        ...
        for ($i = 0; $i < $clen; ++$i) {
            ...
            // intercharacter gap
            $this->barcode_array['bcode'][$k] = array('t' => false, 'w' => 1, 'h' => 1, 'p' => 0);
     ...
     * @return string The encoded code.
     */
    private function encodeExtended($code)
    {
        $encode = array(
    ...
    /**
     * Calculate Code 39 check digit (modulo 43).
     * @param string $code The code to be represented by this barcode.
